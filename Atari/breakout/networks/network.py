...
class Network(object):
  ...
  def build_output_ops(self, input_layer, network_output_type, 
    ...
    #mellowmax
    self.mellowmax_outputs = self.mellowmax(self.outputs, w=1000, n=4, l=32, reduction_indices=1)

  def mellowmax(self, input_tensor, w=1000, n=4, l=32, reduction_indices=1):
