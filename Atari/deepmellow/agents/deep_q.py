...
class DeepQ(Agent):
  ...
  def q_learning_minibatch(self):
    ...
    if self.double_q:
      ...
      if self.mellowmax:
          #mellowmax
          qvals = self.target_network.calc_outputs(s_t_plus_1)
          mellowmax_q_t_plus_1 = self.target_network.calc_mellowmax_outputs(s_t_plus_1, self.w)
          #print("Q")
          #print(qvals)
          #print("w = ", self.w)
          #print("mm_Q")
          #print(mellowmax_q_t_plus_1)

          target_q_t = (1. - terminal) * self.discount_r * mellowmax_q_t_plus_1 + reward
      else:
          #normal version of max
