...
#add mellowmax
flags.DEFINE_boolean('mellowmax',False,'Whether to use mellowmax')
flags.DEFINE_integer('w',0,'Mellowmax parameter w')
...
flags.DEFINE_float('t_target_q_update_freq', 1, 'The frequency of target network to be updated (*= scale)')
